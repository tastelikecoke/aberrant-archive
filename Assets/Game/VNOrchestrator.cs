...
public class VNOrchestrator : MonoBehaviour
{
    ...
    public IEnumerator PlayCR()
    {
        ...
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Shot 1 with Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 1 with Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 2 with Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 3 with Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Shot 2 with Usagi and Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 4 with Character1]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 5 with Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 6 with Character2]");
        yield return WaitForClickCR();
        yield return PlayDialogueCR("TODO Temp!! Replace this", "[Dialogue 7 with Character1]");
        yield return WaitForClickCR();
